...
import { SECTION_LABELS } from '../../pages/jobseeker/profile-sections/requiredFields'
import { Card, CardContent, CardHeader, CardTitle } from './Card'
import { cn } from '../../lib/utils'

/** Groups every required-field check by section, checked or not, and scrolls to the
 * corresponding section (via `id="section-<key>"` on each Card in Profile.jsx) when
 * an unchecked item is clicked. */
export function CompletionChecklist({ completion }) {
