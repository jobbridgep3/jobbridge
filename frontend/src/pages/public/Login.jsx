...
import { ArrowLeft, Bell, Search, Send, ShieldCheck } from 'lucide-react'
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden p-4 py-10">
      ...
      >
        ...
        <div className="hidden flex-col justify-center gap-6 bg-primary-50 p-8 dark:bg-primary-950/40 sm:flex">
          ...
          <div>
            <h2 className="text-xl font-semibold text-primary-900 dark:text-primary-300">Welcome Back!</h2>
            <p className="mt-1 text-sm text-text-secondary">Log in to your JobBridge account to continue.</p>
          </div>
        ...
        <div className="flex flex-col justify-center p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs font-medium text-primary-700 hover:underline dark:text-primary-400">
                  Forgot Password?
                </Link>
              </div>
          ...
          <p className="mt-4 text-center text-sm text-text-secondary">
            ...
            or{' '}
            <Link to="/register?type=employer" className="font-medium text-primary-700 hover:underline dark:text-primary-400">
              Employer
            </Link>
          </p>
        </div>
