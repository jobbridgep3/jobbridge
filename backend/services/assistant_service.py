...
_SYSTEM_KNOWLEDGE = (
    ...
    "supporting documents. All three share the same review workflow: submitted, "
    "optionally moved to under review, then either approved (SPES/OWWA becomes "
    "'endorsed', DILP becomes 'for release', and a release date/amount may be recorded) "
    "or rejected with remarks — staff can also request additional documents without "
    "rejecting the application outright. Exact eligibility and benefits differ per "
    "program.\n"
